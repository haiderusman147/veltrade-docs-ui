...
export default function Home() {
  return (
    <main className="mx-auto max-w-[1320px] px-4 py-10 sm:px-6 sm:py-14">
      <div className="grid grid-cols-1 items-start gap-8 xl:grid-cols-[minmax(0,1fr)_200px]">
        <div className="min-w-0">
          <section className="rounded-2xl border border-zinc-200 bg-white p-6 sm:p-10">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-zinc-600">
                Clear explanations, grounded examples, and a structured
                learning path. Built for people who want to understand markets
          ...
          <section className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-zinc-200 p-6">
              ...
              <p className="mt-2 text-sm text-zinc-600">
                Learn the basics: order types, timeframes, and risk control.
            ...
            <div className="rounded-2xl border border-zinc-200 p-6">
              ...
              <p className="mt-2 text-sm text-zinc-600">
                Wallets, exchanges, fees, stablecoins, and common scams. Focus
                on security before profits.
              </p>
              <Link
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              >
                ...
                <div className="mt-2 text-sm text-zinc-600">
                  The foundation of long-term survival in markets. Position
                  sizing, stop losses, and rule-based thinking.
                </div>
              </Link>
              ...
              >
                ...
                <div className="mt-2 text-sm text-zinc-600">
                  Why leverage changes everything, what liquidation really
                  means, and what beginners should avoid.
                </div>
              </Link>
              ...
              >
                ...
                <div className="mt-2 text-sm text-zinc-600">
                  Trading fees, spreads, and network costs explained simply,
                  with practical ways to reduce fee leakage.
                </div>
              </Link>
              ...
              >
                ...
                <div className="mt-2 text-sm text-zinc-600">
                  A realistic way to think about starting capital, learning
                  funds, and scaling only after discipline is consistent.
                </div>
              </Link>
            </div>
          </section>
          ...
          <section className="mt-10 rounded-2xl border border-zinc-200 bg-white p-6">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              This website is for educational purposes only and does not
              provide financial advice. Trading and investing involve risk and
